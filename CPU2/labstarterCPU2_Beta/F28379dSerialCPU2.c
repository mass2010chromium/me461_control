...
//        sci = &ScibRegs;
//
//			if using Serial B these lines move to CPU1
...
//    } else if (s == &SerialC) {
	if (s == &SerialC) {
		...
		// These below commented lines were moved to CPU1 code
//        GPIO_SetupPinMux(139, GPIO_MUX_CPU2, 6);
//        GPIO_SetupPinOptions(139, GPIO_INPUT, GPIO_PULLUP);
//        GPIO_SetupPinMux(56, GPIO_MUX_CPU2, 6);
//        GPIO_SetupPinOptions(56, GPIO_OUTPUT, GPIO_PUSHPULL);
		
//			if using Serial D these lines move to CPU1
//    } else if (s == &SerialD) {
//        sci = &ScidRegs;
//
